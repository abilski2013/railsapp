...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post interactions_url, params: { interaction: { date: @interaction.date, first_name: @interaction.first_name, last_name: @interaction.last_name, relationship: @interaction.relationship } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { date: @interaction.date, first_name: @interaction.first_name, last_name: @interaction.last_name, relationship: @interaction.relationship } }
